...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    announcements: Schema.Attribute.Component<'shared.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
    ...
    logoLink: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'/'>
    primaryNavigationLinks: Schema.Attribute.Component<'shared.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
    ...
    publishedAt: Schema.Attribute.DateTime
    topBarLinks: Schema.Attribute.Component<'shared.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true
        }
