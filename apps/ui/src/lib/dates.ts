...
export function formatDateRange(startDate: string, endDate: string, format = DATE_FORMAT) {
...
export function formatDate(date: string | Date | undefined, format = DATE_FORMAT): string {
