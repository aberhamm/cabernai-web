      ...
      },
      {
        onError: (error) => {
          ...
          if (error instanceof Error) {
            const errorKey = Object.keys(errorMap).find((key): key is keyof typeof errorMap =>
      ...
      <Card className="m-auto w-[400px]">
        ...
        <CardContent>
          <AppForm form={form} onSubmit={onSubmit} id={registerFormName}>
            <AppField name="firstName" type="text" required label={t('firstName')} />
            <AppField name="lastName" type="text" required label={t('lastName')} />
