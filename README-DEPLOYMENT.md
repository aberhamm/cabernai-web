...
```bash
# Domain and URLs (not sensitive, can be public)
...
**🎯 Benefits of Environment-Based Setup:**
...
- ✅ **Better organization** - Secrets vs Variables are properly separated
- ✅ **Improved security** - URLs are public variables, sensitive data are secrets
- ✅ **Easier management** - URLs can be changed without exposing sensitive information
...
2. **Set up GitHub Environment:**
   ...
   **Variables tab (for URLs and domain):**
   ...
   NEXT_PUBLIC_APP_PUBLIC_URL=https://your-actual-domain.com
   NEXT_PUBLIC_STRAPI_URL=https://your-actual-domain.com
